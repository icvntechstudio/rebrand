	...
	render() {
		return (
		      ...
		      <div className="container mx-auto flex flex-wrap items-center pt-18">
			          ...
			          <i className="fas fa-drafting-compass text-xl"></i>
								...
								<h3 className="text-3xl mb-2 font-semibold leading-normal">
									...
									<p className="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700">
										...
										require JavaScript. In this way you can manipulate the elements on the page and give more options to your users.
									</p>
										<p className="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700">
			      ...
			      <div className="w-full xs:w-full sm:w-full md:w-6/12 lg:w-6/12 xl:w-6/12 px-2 xs:mt-32 sm:mt-32 md:mt-12 lg:mt-32">
