	...
	render() {
		return (
				<section className="pb-32 bg-gray-300 -mt-24">
		            <div className="container mx-auto flex flex-wrap items-center pt-18 px-16">
		                ...
		                <div className="container w-full xs:w-full sm:w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-32">
