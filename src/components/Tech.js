...
class Tech extends Component {
	render() {
		return (
		      ...
		      <div className="container mx-auto flex flex-wrap items-center pt-18 px-4 xs:items-center">
									<div className="container w-full xs:w-full sm:w-full md:w-6/12 px-4 md:px-4 ml-auto mr-auto xs:mt-32 sm:mt-32 md:mt-12">
			              <div className="text-gray-600 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
			          	...
			          	<div className="w-full md:w-6/12 xs:w-6/12 sm:w-full mx-auto mt-12 xs:mt-32 sm:mt-32 md:mt-12 lg:mt-32">
			                <div className="justify-center flex flex-wrap relative">
			                    <div className="my-4 w-full px-2 lg:w-6/12 sm:w-6/12 xs:px-0">
			                  ...
			                  <div className="my-4 w-full px-2 lg:w-6/12 sm:w-6/12 xs:px-0 lg:mt-16">
			                    <a
